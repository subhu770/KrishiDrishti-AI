...
ADVISORY_DB = {
    ...
    "Paddy - Brown Spot": {
        ...
        "odia_advisory": "ଧାନ ଫସଲରେ ବାଦାମୀ ଦାଗ ରୋଗ ଦେଖାଯାଇଛି। ସନ୍ତୁଳିତ ପଟାସ ସାର ପ୍ରୟୋଗ କରନ୍ତୁ ଏବଂ ନିର୍ଦ୍ଦିଷ୍ତ କୀଟନାଶକ ସ୍ପ୍ରେ କରନ୍ତୁ।",
    ...
    <body>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 24px;">
            <div class="advisory-box" style="margin-bottom: 0;">
                <div class="card-title" style="border: none; margin-bottom: 0;">ଓଡ଼ିଆ ଭାଷା ପରାମର୍ଶ (Regional Advisory)</div>
                <div class="odia-text">{request.odia_advisory}</div>
            </div>
            <div class="advisory-box" style="border-left: 5px solid #3b82f6; margin-bottom: 0;">
                <div class="card-title" style="border: none; margin-bottom: 0; color: #1e3a8a;">📋 କୃଷି ବିଶେଷଜ୍ଞ ପରାମର୍ଶ (Agricultural Advisory)</div>
